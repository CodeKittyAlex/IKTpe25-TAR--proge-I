...
namespace University.Data
{
    public static class DbInitalizer
    {
        public static void Initialize(UniversityContext context)
        {
            ...
            //look for any students already in db
            ...
            {
                new Student{FirstMidName="Carson" ,LastName="Aexsander" , EnrollmentDate=DateTime.Parse("2010-09-01")},
                ...
                new Student{FirstMidName="Gystis" ,LastName="Barzdukas" , EnrollmentDate=DateTime.Parse("2012-09-01")},
                ...
                new Student{FirstMidName="Laura" ,LastName="Norwan" , EnrollmentDate=DateTime.Parse("2013-09-01")},
            ...
            var courses = new Course[]
            {
                ...
                new Course{CourseId=2042,Title="Liderature",Credits=4}
            };
